	...
	grunt.initConfig({
		...
		copy: {
			...
			main: {
				src: [
					"**",
					"!*.xml",
					"!*.log", //any config/log files
					"!node_modules/**",
					"!Gruntfile.js",
					"!package.json",
					"!package-lock.json", //npm/Grunt
					...
					"!phpcs.xml.dist",
					"!phpstan.neon.dist",
					"!grumphp.yml.dist", // CodeSniffer Configuration.
		...
		version: {
			class: {
				...
				src: ["<%= pkg.name %>.php", "public/class-local-pickup-time.php"],
			},
			header: {
				options: {
					prefix: "\\* Version:\\s+",
